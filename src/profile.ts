...
export const profile = {
  ...
  funFacts: [
    "2 middles names.",
    "I won a international art competition in high school.",
  ],

  /** One decision you're proud of, in a sentence. */
  decisionImProudOf:
    "I started to read more this summer.",
   ...
   */
  repoUrl: "https://github.com/bethmakori/my-site",
};
