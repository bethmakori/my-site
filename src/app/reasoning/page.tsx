        ...
        {syllogism ? (
          <div className="mt-3 max-w-prose">
            ...
            <p className="mt-2 max-w-prose text-sm text-muted">
              How the service decided: it skips the story and it only looks at the
              argument’s shape. If A is true, B should be true. So only two facts
              actually prove something: A happened, or B did not. Anything else
              proves nothing, even if the story sounds right.
            </p>
          </div>
        ) : (
